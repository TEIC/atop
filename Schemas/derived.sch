...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt3"
    ...
    <!-- In the context of ATOP, this schema (contributed by dmj) validates an 
         ODD which has been derived, prior to its being pruned and localized. 
         It may also be used to test whether any other ODD file is self-contained. -->
