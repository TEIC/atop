<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt3"
  ...
  <sch:p>
    This schema, which (as the title says) tests that an ODD is
    self-contained. The ATOP process uses this test on the output
    of the derivation process, hence the name "derived.sch".    
  </sch:p>
  <sch:p>
    Based entirely on the code written by @dmj for issue #16.
  </sch:p>
